...
public class GLA {
     ...
     */
    final static String SERIALIZATION_FILE_PATH = "./src/analizator/definition.ser";
    private final static String TEST_FILE_INPUT_PATH = "./src/res/in/simplePpjLang.lan";
